...
/**
 * A simple implementation of CustomerLookupService, for testing purposes. Uses
 * a Map of Customers.
 * 
 * From <a href="http://courses.coreservlets.com/Course-Materials/"> the
 * coreservlets.com Java EE tutorials</a>.
 */
...
public class MapCustomerLookupService implements CustomerLookupService {
	...
	/**
	 * Given an id, returns either the corresponding Customer object or null.
	 * Real ids are in lower case, but this accepts input in any case.
	 */
